...
export default function CheckoutSuccessPage() {
  return (
    <section className="mx-auto flex w-full max-w-4xl flex-col items-center px-5 py-24 text-center sm:px-8 md:py-32">
      <p className="text-xs uppercase tracking-[0.2em] text-brand-secondary/55">Order Confirmed</p>
      <h1 className="mt-6 font-serif text-4xl text-brand-secondary sm:text-6xl">Welcome to the Society.</h1>
      <p className="mt-6 max-w-2xl text-sm leading-7 text-brand-secondary/70 sm:text-base">
        Your payment is complete and fulfillment is being sent to production.
      </p>
